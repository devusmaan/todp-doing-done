...
export default function CardTask() {
   ...
   const handleEditTask = () => {
    ...
    const [, uniqueId] = originalTask.split('__'); // preserve the unique ID
    const newTaskValue = `${editedValue}__${uniqueId}`; // updated label with original ID
    ...
    const handleAddTask = () => {
        ...
        const uniqueTask = `${taskValue}__${Date.now()}`; // ✅ hidden unique ID
